...
<head>
    ...
    <!-- Bootstrap + marcelinoatallah main styles -->
	<link rel="stylesheet" href="{{url('asset/css/marcelinoatallah.css')}}">
</head>
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    <a href="#contact" class="btn btn-primary btn-component" data-spy="affix" data-offset-top="600"><i class="ti-shift-left-alt"></i> Hire Me</a>
    <header class="header">

        <div class="theme-container shadow-dark" onclick="setTheme()">
        ...
        <div class="container">
            ...
            <div class="header-content">
                ...
                <h1 class="header-title">Marcelino Atallah</h1>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light " data-spy="affix" data-offset-top="510">
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    <img src="{{url('asset/imgs/Marcelino.jpg')}}" alt="" class="brand-img">
                    <li class="brand-txt">
                        <h5 class="brand-title">Marcelino Atallah</h5>
                ...
                <div class="portfolio-container"> 
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="{{url('asset/imgs/web-1.jpg')}}" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="{{url('asset/imgs/web-1.jpg')}}" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="{{url('asset/imgs/web-1.jpg')}}"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
            ...
            <div class="row">
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="{{url('asset/imgs/blog1.jpg')}}" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
    ...
    <div class="section contact" id="contact">
        ...
        <img id="map" class="map" src="{{url('asset/imgs/map.jpg')}}" alt="">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+ (961) 7 86 94 57</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">Zouk Mosebh , Lebanon.</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">marcelino_atallah@hotmail.com</span></h6>
                            </div>
                        </div>
    ...
    <footer class="footer py-3">
        <div class="container">
            <p class="small mb-0 text-light">
                &copy; <script>document.write(new Date().getFullYear())</script> Created By <a href="http://devcrud.com" target="_blank"><span class="text-danger" title="Bootstrap 4 Themes and Dashboards">Me</span></a> 
            </p>
        </div>
    </footer>
    ...
    <!-- Isotope  -->
    <script src="{{url('asset/vendors/isotope/isotope.pkgd.js')}}"></script>
    
    <!-- Google mpas -->
    <!-- <script async defer src="{{url('asset/js/contactMap.js')}}"></script> -->

    <!-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCtme10pzgKSPeJVJrG1O3tjR6lk98o4w8&callback=initMap"></script> -->

    <!-- marcelinoatallah js -->
    <script src="{{url('asset/js/marcelinoatallah.js')}}"></script>
